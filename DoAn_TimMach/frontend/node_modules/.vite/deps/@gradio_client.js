...
var Qe = "sleeptime";
var Xe = "heartbeat";
var et = "component_server";
var tt = "reset";
var st = "cancel";
var nt = "app_id";
var Ae = "This application is currently busy. Please try again. ";
var L = "Connection errored out. ";
var N = "Could not resolve app config. ";
var ot = "Could not get space status. ";
var it = "Could not get API info. ";
var le = "Space metadata could not be loaded. ";
var rt = "Invalid URL. A full URL path is required.";
var at = "Not authorized to access this space. ";
var xe = "Invalid credentials. Could not login. ";
var ct = "Login credentials are required to access this space.";
var ut = "File system access is only available in Node.js environments";
var Ce = "Root URL not found in client config";
var lt = "Error uploading file";
...
async function dt(e) {
  ...
  if (s["Content-Type"] = "application/json", typeof window < "u" && window.gradio_config && location.origin !== "http://localhost:9876") {
    if (window.gradio_config.current_page && (e = e.substring(0, e.lastIndexOf("/"))), window.gradio_config.dev_mode || typeof window < "u" && (window == null ? void 0 : window.BUILD_MODE) === "dev") {
      let t = ce(
        e,
...
async function ve(e, s) {
  ...
  if ((e == null ? void 0 : e.status) === 401 && !s) {
    const n = (_b = (_a = await e.json()) == null ? void 0 : _a.detail) == null ? void 0 : _b.auth_message;
    throw new Error(n || ct);
  } else if ((e == null ? void 0 : e.status) === 401 && s)
    throw new Error(xe);
  if ((e == null ? void 0 : e.status) === 200) {
    let t = await e.json();
    return (_c = t.dependencies) == null ? void 0 : _c.forEach((n, o) => {
      n.id === void 0 && (n.id = o);
    }), t;
  ...
  return Object.keys(e).forEach((o) => {
    (o === "named_endpoints" || o === "unnamed_endpoints") && (n[o] = {}, Object.entries(e[o]).forEach(
      ([r, { parameters: i, returns: a }]) => {
        var _a, _b, _c, _d;
        const u = ((_a = s.dependencies.find(
          (c) => c.api_name === r || c.api_name === r.replace("/", "")
        )) == null ? void 0 : _a.id) || t[r.replace("/", "")] || -1, l = u !== -1 ? (_b = s.dependencies.find((c) => c.id == u)) == null ? void 0 : _b.types : { generator: false, cancel: false };
        if (u !== -1 && ((_d = (_c = s.dependencies.find((c) => c.id == u)) == null ? void 0 : _c.inputs) == null ? void 0 : _d.length) !== i.length) {
          const c = s.dependencies.find((m) => m.id == u).inputs.map(
            (m) => {
              var _a2;
              return (_a2 = s.components.find((w) => w.id === m)) == null ? void 0 : _a2.type;
            }
          );
          try {
            c.forEach((m, w) => {
        ...
        const p = (c, m, w, P) => ({
          ...c,
          description: gt(c == null ? void 0 : c.type, w),
          type: mt(c == null ? void 0 : c.type, m, w, P) || ""
        });
        n[o][r] = {
          parameters: i.map(
            (c) => p(c, c == null ? void 0 : c.component, c == null ? void 0 : c.serializer, "parameter")
          ),
          returns: a.map(
            (c) => p(c, c == null ? void 0 : c.component, c == null ? void 0 : c.serializer, "return")
          ),
          type: l
        };
      }
...
async function bt(e, s, t) {
  var _a;
  const n = {};
  ((_a = this == null ? void 0 : this.options) == null ? void 0 : _a.token) && (n.Authorization = `Bearer ${this.options.token}`);
  const o = 1e3, r = [];
  let i;
...
var Rt = typeof process < "u" && process.versions && process.versions.node;
function $e(e, s, t) {
  for (; t.length > 1; ) {
    const o = t.shift();
...
async function ue(e, s = void 0, t = [], n = false, o = void 0) {
  if (Array.isArray(e)) {
    let r = [];
    return await Promise.all(
      e.map(async (i, a) => {
        ...
        const l = await ue(
          e[a],
          n ? ((_a = o == null ? void 0 : o.parameters[a]) == null ? void 0 : _a.component) || void 0 : s,
          u,
          false,
          o
        );
...
function Ot(e, s) {
  var _a, _b;
  let t = (_b = (_a = s == null ? void 0 : s.dependencies) == null ? void 0 : _a.find((n) => n.id == e)) == null ? void 0 : _b.queue;
...
function Y(e, s, t, n, o = false) {
  ...
  for (let u = 0; u < a.length; u++) {
    const l = a[u];
    if (((_a = t.find((c) => c.id === l)) == null ? void 0 : _a.type) === "state") {
      if (o)
...
async function xt(e, s) {
  var _a, _b;
  if (!(((_a = e.config) == null ? void 0 : _a.root) || ((_b = e.config) == null ? void 0 : _b.root_url)))
    throw new Error(Ce);
  await Pe(e, s);
}
...
async function Ct(e, s, t) {
  var _a, _b;
  let n = s[t];
  const o = ((_a = e.config) == null ? void 0 : _a.root) || ((_b = e.config) == null ? void 0 : _b.root_url);
  if (!o)
    throw new Error(Ce);
  try {
    let r, i;
    if (typeof process < "u" && process.versions && process.versions.node) {
      const p = await import("./__vite-browser-external-DYxpcVy9-H2ZLLYSD.js");
      i = (await import("./__vite-browser-external-DYxpcVy9-H2ZLLYSD.js")).resolve(process.cwd(), n.meta.path), r = await p.readFile(i);
    } else
      throw new Error(ut);
    const a = new Blob([r], {
...
async function Nt(e, s = {}) {
  ...
  return new Promise(async (o, r) => {
    const i = this.submit(e, s, null, null, true);
    let a;
    for await (const u of i)
      u.type === "data" && (n && o(a), t = true, a = u), u.type === "status" && (u.stage === "error" && r(u), u.stage === "complete" && (n = true, t && o(a)));
  });
}
...
var Lt = /^(?=[^]*\b[dD]iscussions{0,1}\b)(?=[^]*\b[dD]isabled\b)[^]*$/;
async function ke(e) {
  try {
    const s = await fetch(
...
var _e;
var qt = class extends TransformStream {
  /** Constructs a new instance. */
  constructor(s = { allowCR: false }) {
    super({
      transform: (t, n) => {
        for (t = __privateGet(this, _e) + t; ; ) {
          const o = t.indexOf(`
`), r = s.allowCR ? t.indexOf("\r") : -1;
      ...
      flush: (t) => {
        if (__privateGet(this, _e) === "")
          return;
        const n = s.allowCR && __privateGet(this, _e).endsWith("\r") ? __privateGet(this, _e).slice(0, -1) : __privateGet(this, _e);
        t.enqueue(n);
      }
    });
...
_e = new WeakMap();
function zt(e) {
  let s = new TextDecoderStream(), t = new qt({ allowCR: true });
...
async function* Ft(e, s) {
  ...
  for (; ; ) {
    ...
    let [i, a] = Bt(n.value) || [];
    i === "data" ? (r || (r = {}), r[i] = r[i] ? r[i] + `
` + a : a) : i === "event" ? (r || (r = {}), r[i] = a) : i === "id" ? (r || (r = {}), r[i] = String(+a) === a ? +a : a) : i === "retry" && (r || (r = {}), r[i] = +a || void 0);
  }
}
...
function he(e, s) {
  e && (e.open = false, s == null ? void 0 : s.abort());
}
function Ht(e, s, t) {
...
function Kt(e, s = {}, t, n, o, r) {
  ...
  try {
    ...
    let { fn_index: d, endpoint_info: _e2, dependency: B } = Yt(
      J,
      e,
      z,
      f
    ), qe = wt(s, _e2), U, A = f.protocol ?? "ws";
    if (A === "ws")
      throw new Error("WebSocket protocol is not supported in this version");
    let q = "", Qt = () => q;
    const _ = typeof e == "number" ? "/predict" : e;
    let Z, b = null, x = false, me = {}, F = typeof window < "u" && typeof document < "u" ? new URLSearchParams(window.location.search).toString() : "";
    const ze = ((_a = W == null ? void 0 : W.events) == null ? void 0 : _a.reduce(
      (h, R) => (h[R] = true, h),
      {}
    )) || {};
    async function Be() {
      ...
      if (Z = {
        ...
        i({
          ...
          if (v == 200)
            ...
            const O = (y == null ? void 0 : y.error) === L;
            i({
              type: "status",
              stage: "error",
              endpoint: _,
        ...
        U.onmessage = async function(v) {
          ...
          if (O === "update" && C && !x)
            i({
              ...
              time: /* @__PURE__ */ new Date(),
              ...C
            }), C.stage === "error" && (U == null ? void 0 : U.close(), a());
          else if (O === "data") {
            let [k, I] = await oe(
              `${f.root}${T}/queue/data`,
              {
        ...
        let y = "";
        typeof window < "u" && typeof document < "u" && (y = (_a2 = window == null ? void 0 : window.location) == null ? void 0 : _a2.hostname);
        ...
        return (typeof window < "u" && typeof document < "u" && window.parent != window && window.supports_zerogpu_headers ? Tt("zerogpu-headers", j) : Promise.resolve(null)).then((k) => {
          ...
          if (k.event_id && (q = k.event_id), I === 503)
            ...
            const M = (k == null ? void 0 : k.error) === L;
            i({
              type: "status",
              stage: "error",
              broken: M,
            ...
            let M = async function(re) {
              try {
                ...
                if (E === "update" && S && !x)
                  ...
                  console.error("Unexpected error", S == null ? void 0 : S.message);
                  const Je = E === "broken_connection";
                  i({
                    type: "status",
                    stage: "error",
                    message: (S == null ? void 0 : S.message) || "An Unexpected Error Occurred!",
                    queue: true,
                    endpoint: _,
                    broken: Je,
                    session_not_found: S == null ? void 0 : S.session_not_found,
                    fn_index: d,
                    time: /* @__PURE__ */ new Date()
                  });
                } else if (E === "log") {
                ...
                $ && (i({
                  ...
                  endpoint: _,
                  fn_index: d
                }), a())), ((S == null ? void 0 : S.stage) === "complete" || (S == null ? void 0 : S.stage) === "error") && (ne[b] && delete ne[b], b in se && delete se[b]);
              } catch (E) {
                console.error("Unexpected client exception", E), i({
                  ...
                  fn_index: d,
                  time: /* @__PURE__ */ new Date()
                }), ["sse_v2", "sse_v2.1", "sse_v3"].includes(A) && (he(ee, Ue.abort_controller), ee.open = false, a());
              }
            };
...
var Q = class {
  constructor(s, t = { events: ["data"] }) {
    ...
    var _a;
    this.app_reference = s, this.deep_link = ((_a = t.query_params) == null ? void 0 : _a.deep_link) || null, t.events || (t.events = ["data"]), this.options = t, this.current_payload = {}, t.cookies && (this.cookies = t.cookies), this.view_api = yt.bind(this), this.upload_files = bt.bind(this), this.handle_blob = At.bind(this), this.post_data = Dt.bind(this), this.submit = Kt.bind(this), this.predict = Nt.bind(this), this.open_stream = Mt.bind(this), this.resolve_config = dt.bind(this), this.resolve_cookies = ht.bind(this), this.upload = kt.bind(this), this.fetch = this.fetch.bind(this), this.handle_space_success = this.handle_space_success.bind(this), this.stream = this.stream.bind(this);
  }
  ...
  async init() {
    ...
    ), this.api_info = await this.view_api(), this.api_map = pt(((_a = this.config) == null ? void 0 : _a.dependencies) || []);
  }
  ...
  close() {
    this.closed = true, he(this.stream_status, this.abort_controller);
  }
  ...
  async handle_space_success(s) {
    ...
    if (t && t(s), s.status === "running")
      try {
        if (this.config = await this._resolve_config(), this.api_prefix = ((_a = this == null ? void 0 : this.config) == null ? void 0 : _a.api_prefix) || "", !this.config)
          throw new Error(N);
  ...
  async component_server(s, t, n) {
    ...
    ((_a = u == null ? void 0 : u.props) == null ? void 0 : _a.root_url) ? a = u.props.root_url : a = this.config.root;
    let l;
